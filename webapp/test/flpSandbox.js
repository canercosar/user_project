		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "User Project",
									"targetURL": "#comnttccuserproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnttccuserproject-display": {
								"semanticObject": "comnttccuserproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ntt.cc.userproject",
									"url": sap.ui.require.toUrl("com/ntt/cc/userproject")
								}
							}
						}
					}
